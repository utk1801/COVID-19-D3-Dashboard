function donutChart() {
    ...
    function chart(selection){
        selection.each(function(data) {
            ...
            var svgdonut = selection.append('svg')
                .attr('width', width)
                .attr('height', height)
              .append('g')
            ...
            svgdonut.append('g').attr('class', 'slices');
            svgdonut.append('g').attr('class', 'labelName');
            svgdonut.append('g').attr('class', 'lines');
            // ===========================================================================================
            ...
            // ===========================================================================================
            // add text labels
            var label = svgdonut.select('.labelName').selectAll('text')
                .data(pie)
              .enter().append('text')
                .attr('dy', '.25em')
                .style('fill','white')
            ...
            function toolTipHTML(data) {
                ...
                for (var key in data.data) {
                    ...
                    var value = (!isNaN(data.data[key])) ? data.data[key] : data.data[key];
    ...
    d3.csv('static/top_10_cropped.csv', function(error, data) {
